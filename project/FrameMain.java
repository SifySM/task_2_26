...
import edu.vsu.ru.util.LinkedListUtils;
...
public class FrameMain extends JFrame {
    ...
    public FrameMain() {
        ...
        buttonLoadDataFromFile.addActionListener(actionEvent -> {
            try {
                if (fileChooserOpen.showOpenDialog(PanelMain) == JFileChooser.APPROVE_OPTION) {
                    ...
                    JTableUtils.writeArrayToJTable(tableSource, LinkedListUtils.convertToIntArray(LList));
                }
            } catch (Exception e) {
        ...
        buttonFindSequence.addActionListener(actionEvent -> {
            try {
                MyLinkedList<Integer> linkedList = LinkedListUtils.readLListFromJTable(tableSource);
                linkedList = linkedList.convert();
                JTableUtils.writeArrayToJTable(tableFinal, LinkedListUtils.convertToIntArray(linkedList));
            } catch (Exception e) {
                SwingUtils.showErrorMessageBox(e);
            }
        });
